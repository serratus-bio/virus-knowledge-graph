...
def run(args):
    ...
    if args.task == 'all' or args.task == 'edges':
        ...
        feature_queries.write_to_feature_store(
            has_host_edges_fts, 'n4j_has_host_edges.csv')
